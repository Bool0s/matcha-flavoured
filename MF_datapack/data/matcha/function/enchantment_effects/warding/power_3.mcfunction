...
execute if entity @e[distance=..8,predicate=matcha:wearing_copper_armour] as @n[predicate=matcha:wearing_copper_armour] run return run function matcha:enchantment_effects/warding/effects/apply_warding_resistance

# Wither is special, he gets targeted before other mobs
execute if entity @e[distance=..12,type=wither] as @n[type=wither] run return run function matcha:enchantment_effects/warding/effects/apply_damage.macro {damage:1}
...
execute as @n[distance=..8,type=#matcha:warding_targets] run function matcha:enchantment_effects/warding/effects/apply_damage.macro {damage:1}
