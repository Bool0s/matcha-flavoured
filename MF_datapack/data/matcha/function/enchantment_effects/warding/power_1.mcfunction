...
execute if entity @e[distance=..3,predicate=matcha:wearing_copper_armour] as @n[predicate=matcha:wearing_copper_armour] run return run function matcha:enchantment_effects/warding/effects/apply_warding_resistance
...
execute as @n[distance=..3,type=#matcha:warding_targets,type=!wither] run function matcha:enchantment_effects/warding/effects/apply_damage.macro {damage:1}