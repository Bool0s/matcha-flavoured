...
execute as @e[type=marker,tag=beacon_kindling,tag=!summoned_trader] if score @s wandering_trader_timer_score >= 10min wandering_trader_timer_score at @s run function matcha:mechanic/wandering_trader/summon_wandering_trader
execute as @e[type=marker,tag=beacon_kindling,tag=summoned_trader] if score @s wandering_trader_timer_score >= 15min wandering_trader_timer_score at @s run function matcha:mechanic/wandering_trader/kill_wandering_trader
...
execute as @e[type=marker,tag=beacon_kindling] at @s unless block ~ ~ ~ minecraft:campfire[lit=true] run function matcha:mechanic/wandering_trader/kill_wandering_trader_early
...
execute as @e[type=marker,tag=beacon_kindling] if score @s wandering_trader_timer_score <= 15min wandering_trader_timer_score run schedule function matcha:mechanic/wandering_trader/check_wandering_trader_timer_loop 10s
