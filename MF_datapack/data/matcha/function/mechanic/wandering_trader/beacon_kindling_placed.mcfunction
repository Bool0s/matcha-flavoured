...
execute if entity @s[tag=SummonedTrader] at @n[type=marker,tag=beacon_kindling,tag=!beacon_kindling_init] run function matcha:mechanic/wandering_trader/kill_this_beacon
execute if entity @s[tag=!SummonedTrader] run function matcha:mechanic/wandering_trader/initialise_wandering_trader_spawn
