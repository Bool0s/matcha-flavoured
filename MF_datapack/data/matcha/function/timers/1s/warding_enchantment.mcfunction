...
execute as @a[scores={WardingPower=1}] run function matcha:enchantment_effects/warding/power_1
execute as @a[scores={WardingPower=2}] run function matcha:enchantment_effects/warding/power_2
