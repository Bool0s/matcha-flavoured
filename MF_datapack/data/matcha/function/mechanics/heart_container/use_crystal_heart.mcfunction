...
execute if predicate matcha:crystal_heart/not_holding_totem run execute if score @s Hearts < $Max Hearts run function matcha:mechanics/heart_container/clear_crystal_heart
...
schedule function matcha:mechanics/heart_container/revoke_crystal_heart_adv 1s
